...
Import through ``tors.documents`` — this package's name is the wire it rides
on, not the surface callers should target.
...
# release, two wheels — so the native constant IS the wheel version; the
