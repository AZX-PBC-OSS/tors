...
mirror `urllib.parse`; `b64_encode_bytes`/`b64_decode` mirror `base64`;
the one-shot hashing family mirrors `hashlib`/`hmac`). Where
...
88 functions plus two small helper classes and five pinned charset constants,
